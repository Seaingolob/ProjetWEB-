        ...
        <div class="admin-sections">
            ...
            <div class="admin-content">
                ...
                <div class="offer-management" id="section-offre">
                    <h3>Gestion des offres d'entreprises informatiques :</h3>
                    <button class="action-btn">Ajouter une offre</button>
                    
                    <div class="offers-container">
                        <div class="offer-card">
                            <div class="offer-header">ID : 001</div>
                        ...
                        <div class="offer-card">
                            <div class="offer-header">ID : 002</div>
                            <div class="offer-details">
                        ...
                        <div class="offer-card">
                            <div class="offer-header">ID : 003</div>
                            <div class="offer-details">
                        ...
                        <div class="offer-card">
                            <div class="offer-header">ID : 004</div>
                            <div class="offer-details">
