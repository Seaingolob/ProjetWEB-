...
<body>
    ...
    <main>
                            ...
                            <?php foreach ($searchCompetences as $index => $selectedCompetence): ?>
                                <div class="competence-row">
                                    ...
                                    <button type="button" class="remove-competence-btn"
                                        style="<?php echo $index === 0 && count($searchCompetences) === 1 ? 'display: none;' : ''; ?>">-</button>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </div>
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="?<?php echo buildPaginationParams($page - 1, $searchCompany, $searchLocation, $searchCompetences); ?>"
            ...
            <div class="page-numbers">
                ...
                if ($startPage > 1): ?>
                    <a
                        href="?<?php echo buildPaginationParams(1, $searchCompany, $searchLocation, $searchCompetences); ?>">1</a>
                    <?php if ($startPage > 2): ?>
                ...
                <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                    <a href="?<?php echo buildPaginationParams($i, $searchCompany, $searchLocation, $searchCompetences); ?>"
                ...
                <?php if ($endPage < $totalPages): ?>
                    ...
                    <?php endif; ?>
                    <a
                        href="?<?php echo buildPaginationParams($totalPages, $searchCompany, $searchLocation, $searchCompetences); ?>"><?php echo $totalPages; ?></a>
                <?php endif; ?>
            </div>
